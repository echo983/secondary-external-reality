...
Valid Chinese example: {"schemaVersion":"0.7.0","inputLanguage":"zh","exitKind":"actions","steps":[{"stepId":"s1","primitive":"open","actor":"self","roles":[{"role":"target","mention":"抽屉"}],"modifiers":{}}]}
Valid compound example for "I open the drawer and look at the key inside": {"schemaVersion":"0.7.0","inputLanguage":"en","exitKind":"actions","steps":[{"stepId":"s1","primitive":"open_and_observe","actor":"self","roles":[{"role":"target","mention":"the key"},{"role":"destination","mention":"the drawer"}],"modifiers":{}}]}
Valid English zero-step example: {"schemaVersion":"0.7.0","inputLanguage":"en","exitKind":"not_an_action","steps":[]}
