...
export const INTERACTION_OPERATIONS = ["take", "place", "put_inside", "open", "close", "observe", "write", "read", "look_around", "inspect_contents", "locate", "inventory", "move", "unknown"] as const;
