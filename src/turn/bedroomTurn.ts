...
export interface InterfaceTurnResult {
  ...
  code: "CONVERSATION" | "INCOMPLETE_FRAGMENT" | "UNSUPPORTED_WORLD_SCOPE" | "UNSUPPORTED_CAPABILITY" | "UNSUPPORTED_MODIFIER" | "AMBIGUOUS_REFERENCE" |
    ...
    "INTERACTION_MISSING_TARGET" | "INTERACTION_MISSING_DESTINATION" | "INTERACTION_AMBIGUOUS_REFERENCE" | "INTERACTION_INVALID_LITERAL" | "INTERACTION_UNSUPPORTED_OPERATION";
  intent: NormalizedIntent;
  commitPackage: never;
  commitPackages?: never;
  partial?: false;
